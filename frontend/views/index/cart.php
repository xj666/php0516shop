	...
	<div class="topnav">
		<div class="topnav_bd w990 bc">
			...
			<div class="topnav_right fr">
				<ul>
                    <li>您好，欢迎来到京西！[<a href="<?=Yii::$app->user->isGuest?\yii\helpers\Url::to(['member/login']) :\yii\helpers\Url::to(['member/logout'])?>"><?=Yii::$app->user->isGuest? '登录':'退出'?></a>] [<a href="<?=\yii\helpers\Url::to(['member/add'])?>">免费注册</a>] </li>
					<li class="line">|</li>
					<li>我的订单</li>
					<li class="line">|</li>
					<li>客户服务</li>
...
//            var_dump($models);exit;
			...
			<tfoot>
				<tr>
					<td colspan="6">购物金额总计： <strong>￥ <span id="total"><?=$mon?>.00</span></strong></td>
				</tr>
			</tfoot>
		</table>
