                ...
                <dd>
                    ...
                    <ul>
                        <li>
                            ...
                            [<a href="<?=\yii\helpers\Url::to(['member/register'])?>">注销</a>]
                        </li>
                    </ul>
                    </div>
                ...
                <?php foreach ($goods as $good): ?>
                    <div class="cat">
                        ...
                        <div class="cat_detail">
                            <!--循环二级分类-->
                            <?php
                            $values=\backend\models\GoodsCategory::find()->where(['parent_id'=>$good->id])->all();
                            foreach ($values as $value):
                                ?>
                                <!--循环三级分类-->
                                <dl class="dl_1st">
                                    <dt><a href="<?=\yii\helpers\Url::to(['index/list?id='.$value->id])?>"><?=$value->name?></a></dt>
                                    <?php
                                    $datas=\backend\models\GoodsCategory::find()->where(['parent_id'=>$value->id])->all();
                                    foreach ($datas as $data):
                                        ?>
                                        <dd>
                                            <a href="<?=\yii\helpers\Url::to(['index/goods?id='.$data->id])?>"><?=$data->name?></a>
                                        </dd>
                                    <?php endforeach; ?>
                                </dl>
                            <?php endforeach; ?>
