            ...
            <div class="preview fl">
                <div class="midpic">
                    <a href="<?=$goods->logo?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
                        <img src="<?=$goods->logo?>" alt=""  style="width: 350px; height: 351px;"/>               <!-- 第一幅图片的中图 -->
                    </a>
                </div>
                    ...
                    <div class="smallpic_wrap">
                        <ul>
                            ...
                            <?php foreach ($gallerys as $gallery):?>
                                <li class="cur">
                                    <a class="" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?='http://admin.yiishop.com'.$gallery->path?>',largeimage: '<?='http://admin.yiishop.com'.$gallery->path?>'}"><img src="<?='http://admin.yiishop.com'.$gallery->path?>"></a>
                                </li>
                            <?php endforeach; ?>
                        </ul>
                    </div>
